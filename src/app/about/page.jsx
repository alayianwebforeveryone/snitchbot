  ...
  return (
    <>
      ...
      <div className="min-h-screen mt-[40px] flex flex-col items-center justify-center py-16 px-6 sm:px-8 lg:px-16">
        ...
        <div className="max-w-4xl w-full bg-white p-10 rounded-xl shadow-2xl transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
          {/* About Heading */}
          ...
          <div className="text-center mb-8">
            <h3 className="text-3xl font-semibold text-[#40ac78] mb-6">Meet Our Team</h3>
            <div className="flex justify-center space-x-12">
              <div className="flex flex-col items-center space-y-2">
                ...
                />
                <p className="text-lg font-medium text-[#6d68cb]">John Doe</p>
              ...
              <div className="flex flex-col items-center space-y-2">
                <img
                  ...
                  className="rounded-full shadow-lg"
                />
                <p className="text-lg font-medium text-[#6d68cb]">Jane Smith</p>
              ...
              <div className="flex flex-col items-center space-y-2">
                <img
                  ...
                  className="rounded-full shadow-lg"
                />
                <p className="text-lg font-medium text-[#6d68cb]">Michael Lee</p>
